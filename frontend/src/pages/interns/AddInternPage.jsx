...
import { createIntern } from "../../services/internApi";
...
const AddInternPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError("Could not create intern. Please try again.");
    } finally {
  ...
  return (
    <AdminLayout pageTitle="Add Intern">
      <div className="mx-auto max-w-2xl space-y-5">
        ...
        <Card className="border-slate-200 shadow-sm">
          <CardHeader className="border-b border-slate-100 px-6 py-5">
            <CardTitle className="text-lg font-semibold text-slate-800">New Intern</CardTitle>
          </CardHeader>
